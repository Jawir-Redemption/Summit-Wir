<nav id="navbar" class="fixed top-0 left-0 w-full z-50 transition-all duration-500 bg-transparent">
  <div class="container mx-auto flex items-center justify-between py-4 px-6">
    ...
    {{-- Logo kiri --}}
    <a href="/customer/home" class="flex items-center space-x-2 scroll-smooth">
    ...
    <ul class="hidden md:flex space-x-8 font-medium absolute left-1/2 transform -translate-x-1/2">
      <li><a href="{{ url('/customer/home') }}" class="nav-link text-white hover:text-green-400 transition">Home</a></li>
      <li><a href="{{ url('/products') }}" class="nav-link text-white hover:text-green-400 transition">Products</a></li>
      <li><a href="{{ url('/guide') }}" class="nav-link text-white hover:text-green-400 transition">Guide</a></li>
    </ul>

    {{-- Bagian kanan: Cart & Account --}}
    <div class="hidden md:flex items-center space-x-6">
      <a href="{{ url('/cart') }}" class="text-white hover:text-green-400 transition" title="Keranjang">
      ...
      <a href="{{ url('/account') }}" class="text-white hover:text-green-400 transition" title="Akun">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
      ...
      @else
        <a href="{{ route('login') }}" class="bg-gray-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 transition text-sm">
          Login
        </a>
      @endauth
    </div>
  ...
  <div id="mobile-menu" class="md:hidden bg-white/95 backdrop-blur-md border-t overflow-hidden max-h-0 transition-[max-height_opacity] duration-300 ease-in-out opacity-0">
    <ul class="flex flex-col space-y-2 p-4 text-gray-800 font-medium">
      <li><a href="{{ url('/customer/home') }}" class="block py-2 hover:text-green-600 transition">Home</a></li>
      <li><a href="{{ url('/products') }}" class="block py-2 hover:text-green-600 transition">Products</a></li>
      <li><a href="{{ url('/guide') }}" class="block py-2 hover:text-green-600 transition">Guide</a></li>
      <li><a href="{{ url('/cart') }}" class="block py-2 hover:text-green-600 transition">Cart</a></li>
      <li><a href="{{ url('/account') }}" class="block py-2 hover:text-green-600 transition">Account</a></li>
    </ul>
  </div>
</nav>
